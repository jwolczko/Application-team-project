...
Okres sprintu: 18.05 - 23.05.2026
...
S5-02 & Kafelki produktów i saldo łączne w UI & 5 & Done \\
...
Cel sprintu: Dashboard i model odczytowy. Pokazanie klientowi aktualnego stanu produktów, salda łącznego i ostatnich zdarzeń w panelu bankowości.

Zakres sprintu obejmował 4 historyjek o łącznej estymacji 31 SP. Wszystkie historyjki zostały dowiezione ze statusem Done, dlatego osiągnięta prędkość sprintu wyniosła 31 SP.

Dostarczono dashboard klienta oparty o model odczytowy: saldo łączne, kafelki produktów oraz oś czasu zdarzeń. Projekcje aktualizują dane widoczne w panelu po operacjach finansowych.
...
\item Wyświetlono kafelki produktów i saldo łączne.
\item Wdrożono projekcje zdarzeń domenowych.
\item Udostępniono oś czasu ostatnich zdarzeń.
\end{itemize}

\subsection*{Retrospekcja sprintu}
Retrospekcja pokazała, że przepływ danych przez outbox i projekcje trzeba testować całościowo, a nie tylko na poziomie pojedynczych handlerów.
...
Energia zespołu była stabilna. Największym wyzwaniem była synchronizacja modelu zapisu, outboxa, projekcji i widoku frontendu.
