...
| --- | --- | --- | --- | ---: | --- |
| S1-01 | Sprint 1 | E01 | Struktura rozwiązania backendowego | 8 | to do |
| S1-02 | Sprint 1 | E01 | CQRS, obsługa wyjątków i kontrakty API | 8 | to do |
| S1-03 | Sprint 1 | E01 | Frontend React/Vite i podstawowa nawigacja | 5 | to do |
| S1-04 | Sprint 1 | E01 | Bazy danych write/read | 5 | to do |
| S2-01 | Sprint 2 | E02 | Rejestracja profilu klienta | 8 | to do |
| S2-02 | Sprint 2 | E02 | Walidacja danych rejestracyjnych | 5 | to do |
| S2-03 | Sprint 2 | E02 | Bezpieczne hashowanie haseł | 5 | to do |
| S2-04 | Sprint 2 | E02 | Kontrakt rejestracji i dokumentacja requestu | 3 | to do |
| S3-01 | Sprint 3 | E03 | Logowanie klienta | 8 | to do |
| S3-02 | Sprint 3 | E03 | Token JWT i dane sesji | 8 | to do |
| S3-03 | Sprint 3 | E03 | Autoryzacja chronionych endpointów | 5 | to do |
| S3-04 | Sprint 3 | E03 | Spójna obsługa błędów logowania | 3 | to do |
| S4-01 | Sprint 4 | E04 | Otwarcie rachunku bankowego | 8 | to do |
| S4-02 | Sprint 4 | E04 | Dodawanie produktu finansowego | 8 | to do |
| S4-03 | Sprint 4 | E05 | Wypłata środków z rachunku | 8 | to do |
| S4-04 | Sprint 4 | E05 | Wpłata przychodząca i blokada niedozwolonego salda | 8 | to do |
